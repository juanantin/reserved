...
// End-to-end smoke test against a BSC testnet deployment: registers a simulated AMM
// pair, exercises buy/sell tax, burn, a mock reserve-asset deposit, and redeem.
// Set TOKEN_ADDRESS and VAULT_ADDRESS to your own deployment before running.
//
// IMPORTANT: step [1] calls token.setAmmPair() directly as the deployer, which requires
// the deployer to still be the contract owner. Point this at a fresh, not-yet-timelocked
// deployment, or extend it to schedule+execute through the timelock instead.
