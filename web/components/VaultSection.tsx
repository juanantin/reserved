...
export function VaultSection() {
  return (
    <section id="vault" className="border-t border-white/10 bg-rsvd-navy px-6 py-20">
      <div className="mx-auto max-w-6xl">
        <FadeIn>
          <h2 className="text-3xl font-bold md:text-4xl">Vault</h2>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {facts.map((fact, i) => (
            <FadeIn key={fact.label} delay={i * 0.08} className="rounded-lg border border-white/10 bg-rsvd-black/40 p-6">
