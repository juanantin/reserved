...
//
// IMPORTANT: step [1] calls token.setAmmPair() directly as the deployer, which
// requires the deployer to still be the contract owner. Point this at a fresh,
// not-yet-timelocked deployment, or extend it to schedule+execute through the
// timelock instead.
